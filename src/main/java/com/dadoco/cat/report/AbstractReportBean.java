...
public abstract class AbstractReportBean {
    ...
    public AbstractReportBean() {
        ...
        public void exportarPDF(){
            File jasper = new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/cat/reportes/jasper/report3.jasper"));
            
            //JasperPrint jasperPrint = JasperFillManager.fillReport(jasper.getPath(), null, null);
        }
