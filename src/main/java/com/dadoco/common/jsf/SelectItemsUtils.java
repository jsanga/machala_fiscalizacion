...
import com.dadoco.auth.controller.UsuarioAdminViewController;
...
public class SelectItemsUtils {
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(SelectItemsUtils.class);
    ...
    private static Object findValueByStringConversion(FacesContext context, UIComponent component, Iterator<SelectItem> items, String value, Converter converter) {
        log.error("Executing method: findValueByStringConversion value="+value);
