 ...
 * @author dfcalderio
 */
@Named(value = "coefEstrucAcabadoView")
@ViewScoped
public class EstructuraAcabadosViewController implements Serializable {
    ...
    public void init() {
        ...
        for (int i = 0; i < valores.size(); i += cantidadDebil) {
            ...
            Object[] params2 = {24, valores.get(i).getValorFuerte().getValorDiscretoPK().getValor(), idVariable,anioEmision};
    ...
    public void inicializarEdicion(ValorDiscretoPK id) {
        ...
        Object[] params2 = {24, id.getValor(), idVariable, anioEmision};
    ...
    public List<SelectItem> getVariables() {
        variables = new ArrayList<>();
        variables.add(new SelectItem(27, "SOBREPISO"));
        variables.add(new SelectItem(28, "REVESTIMIENTO"));
        variables.add(new SelectItem(30, "CUBIERTA"));
        variables.add(new SelectItem(31, "VENTANAS"));
        return variables;
    }
