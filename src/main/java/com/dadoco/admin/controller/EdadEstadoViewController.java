 ...
 * @author dfcalderio
 */
@Named(value = "coefEdadEstadoView")
@ViewScoped
public class EdadEstadoViewController implements Serializable {
  private static final org.slf4j.Logger log = LoggerFactory.getLogger(EstructuraNivelViewController.class);
    ...
    public void init() {
        ...
        for (int i = 0; i < valores.size(); i += cantidadDebil) {
            ...
            Object[] params2 = {22, valores.get(i).getValorFuerte().getValorDiscretoPK().getValor(),23, anioEmision};
    ...
    public void inicializarEdicion(ValorDiscretoPK id) {
        ...
        Object[] params2 = {22, id.getValor(),23, anioEmision};
